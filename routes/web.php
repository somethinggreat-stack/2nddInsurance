...
// Lead capture
// "Get a Quote" now routes everyone into the multi-step questionnaire.
Route::get('/get-a-quote', fn () => redirect()->route('questionnaire'))->name('quote');
Route::post('/request-callback', [LeadController::class, 'storeCallback'])->name('callback.store');
Route::get('/schedule-consultation', [LeadController::class, 'consultationForm'])->name('consultation');
Route::post('/schedule-consultation', [LeadController::class, 'storeConsultation'])->name('consultation.store');
