...
@section('description', 'Privacy Policy for ' . $site['brand'] . ', sponsored by Farmers Insurance. How we collect, use and protect your information.')
...
<section class="section">
    <div class="container container-narrow" style="line-height:1.8;color:var(--slate-700)">
        <div class="stack reveal">
            <p>{{ $site['brand'] }} ("we," "us," or "our"), sponsored by {{ $site['company'] }}, respects your privacy. This policy explains what information we collect through this website and how we use it.</p>
            ...
            <p>Questions about this policy? Reach out to {{ $site['brand'] }} at <a href="mailto:{{ $site['email'] }}" class="text-red">{{ $site['email'] }}</a> or <a href="tel:{{ $site['phone_raw'] }}" class="text-red">{{ $site['phone'] }}</a>, or by mail at {{ $site['address'] }}, {{ $site['city'] }}, {{ $site['state'] }} {{ $site['zip'] }}.</p>
