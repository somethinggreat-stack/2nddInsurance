...
@section('description', 'Answers to common questions about Auto, Home, Life and Business insurance with Patrick Yasso, your local Michigan Farmers Insurance agent.')
...
<section class="section--tight">
    <div class="container">
        <div class="card reveal" style="text-align:center;max-width:680px;margin-inline:auto;background:var(--grad-navy-deep);border:0;color:#fff">
            ...
            <p style="color:#bccbea">I'm happy to help — no pressure, just honest answers.</p>
