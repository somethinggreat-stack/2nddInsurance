...
@section('description', 'Thank you for reaching out. Patrick Yasso will be in touch shortly with your personalized insurance options.')
...
<section class="section" style="min-height:60vh;display:grid;place-items:center">
    <div class="container container-narrow" style="text-align:center">
        ...
        <p class="lead mx-auto" style="max-width:56ch;margin-top:1rem">Your request is in good hands. {{ $site['agent'] }} will personally review your details and reach out shortly with your tailored insurance options.</p>

        <div class="cards-3 mt-4" style="text-align:left">
            <div class="card"><div class="card__ico ig-red"><x-icon name="document" /></div><h3 style="font-size:1.15rem">I Review</h3><p>I personally review your needs to find the best coverage and savings.</p></div>
            <div class="card"><div class="card__ico ig-blue"><x-icon name="phone" /></div><h3 style="font-size:1.15rem">I Reach Out</h3><p>You'll hear from me soon — usually the same business day.</p></div>
        ...
        <div class="card mt-4" style="background:var(--grad-navy-deep);border:0;color:#fff;max-width:560px;margin-inline:auto">
            ...
            <p style="color:#bccbea">I'm just a call or text away.</p>
